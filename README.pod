...
Now it is even more faster than with FHF.

In compare to C<Moose> version, using L<Mouse> makes possible to increase performance
up to B<50%> (according to benchmarks)!
